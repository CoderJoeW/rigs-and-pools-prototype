...
export const rigClass = frame => CLASS[frame] || 'frame';

const SHOTS = import.meta.glob('../assets/rig/*.webp', { eager: true, import: 'default' });

export function rigShot(frame, state) {
