import { createWeatherService, type DayWeather } from '../services/weatherService.js';
import { dayIndexOf } from '../utils/calendar.js';
import type { Game } from './types.js';

const FALLBACK_READING: DayWeather = { cloud:0.3, wind:0.5 };
