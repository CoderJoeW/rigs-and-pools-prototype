...
/* The chain's own plate, bled in from the left behind the header and masked
   out before it reaches the numbers on the right. Not a full-bleed banner:
   the card's text is ink-on-card in both themes, and turning it light to sit
   on a photograph would have made these the only cards in the app that do.
   Held at --plate-a so it reads at the same strength on either ground. */
.cc-plate{position:absolute;inset:0 0 auto 0;height:96px;z-index:0;pointer-events:none;
