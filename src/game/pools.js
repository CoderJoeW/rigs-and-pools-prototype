...
export function installPools(G){
  ...
  Object.assign(G, {addBond,bondFloor,closePool,doSell,dripCost,dripWorst,fireDrip,foundPool,poolProfit,releaseBond,sell,setDrip,setPoolFee,toggleHold,topUpBond,withdrawProfit});
}
