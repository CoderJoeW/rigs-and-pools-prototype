...
export function installPersistence(G){
  ...
  G.__exports={ s:G.s,C,SHELLS,SOURCES,PLANTS,STORAGE,FABS,FAB,PSUS:G.livePsus,
    ...
    stepTick:G.stepTick,FLOOR_COST:G.FLOOR_COST,FLOOR_RIG:G.FLOOR_RIG,build:G.build,scrapRig:G.scrapRig,swapWorn:G.swapWorn,expectedDay:G.expectedDay,powerRateDay:G.powerRateDay,
